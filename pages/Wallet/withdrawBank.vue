<template>
  <div>
    ...
    <div class="text-center card-header p-20">
        ...
        <h3 style="margin-top: 0px; font-weight: 400;">How much do you want to withdraw ?</h3>
    </div>
    <div class="ui four column doubling stackable grid container" style="margin-top: 30px;">
        <div class="sixteen wide column">
            <div class="ui card deposit-card">
                <div class="center aligned ui form">
                    <div class="ui left labeled input">
                        <div class="ui basic label" style="font-weight: 400; line-height: 2.5em;">NGN</div><input placeholder="Amount" class="action-input" type="text" value="0" style="max-width: 80%;">
                    </div><span class="text-blue" style="border-bottom: 1px dashed rgb(238, 238, 238); display: inline-block; margin-top: 10px;">Balance: NGN 0</span><br><small>Maximum is 2,000,000 and minimum is 500</small><button type="submit" class="blue ui button m-t-4">Proceed with withdrawal</button>
                </div><a id="gotoAccount" hidden="" href="/wallet/withdraw/account"></a>
            </div>
        </div>
    </div>
</div>

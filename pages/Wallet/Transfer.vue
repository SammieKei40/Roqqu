    ...
    <div class="grid container">
        <div class="ui four column doubling stackable grid container" style="margin-top: 30px;">
            <div class="sixteen wide column">
                <div class="ui card deposit-card" style="border: 0.5px dashed rgb(0, 29, 83);"><a class="ui blue right corner label"><i class="exchange icon"></i></a>
                    <h2 class="text-center font-bold" style="font-weight: 400; padding-bottom: 10px;">Fiat Transfer</h2>
                    <div class="ui form">
                        <div class="field"><label>Email / Phone Number of recipient</label><input type="email" spellcheck="false" required="" name="email" placeholder="Email address or phone number"></div>
                        <div class="field">
                                ...
                                <div class="item" style="margin-top: 0px; margin-bottom: 0px;">
                                    <div class="middle aligned content">
                                        <div class="ui negative message" style="width: 100%;">
                                            <p class="text-orange"><i class="icon exclamation triangle"></i>Could not verify recipient.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="field"><label>Amount</label><input placeholder="Amount" type="text" value=""><span class="text-blue" style="border-bottom: 1px dashed rgb(238, 238, 238); display: inline-block; margin-top: 10px;">Balance: NGN 0</span><br><small>Maximum is 10,000,000 and minimum is 500</small></div>
                        <div class="field"><label>Narration (optional)</label><input type="text" spellcheck="false" name="narration" placeholder="Transfer narration" value=""></div>
                    </div><button disabled="" class="ui button w-100 blue btn" style="margin-top: 10px;">Transfer Now</button>
                </div>
            </div>
        </div>
    </div>

        ...
        <div class="wallet-wrapper">
            <div class="ui three column doubling stackable grid container">
                <div class="sixteen wide column">
                    <div class="ui card w-100"><img class="img-save" src="/static/media/savings.7bf2368a.png"></div>
                </div>
                            ...
                            <div class="ui grid" style="">
                                <div class="sixteen wide column">
                                    <div class="content text-center" style="padding: 20px;">
                                        <p class="text-green" style="margin-bottom: 0px;">Crypto Savings</p>
                                        <h3 class="font-bold" style="font-weight: 400; margin-top: 5px; margin-bottom: 5px;">Save funds in USDT, 1 USDT = $1</h3><small class="text-muted">Savings help you lock down funds in crypto, unaccessible by no one else but you, free from devaluation and depreciation, you also earn monthly up to 15% per anum.</small><br><a class="ui button blue" href="/wallet/save/options" style="margin-top: 20px;">Start Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>

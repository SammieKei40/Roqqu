        ...
        <div style="overflow-x: hidden;">
            <div class="nav-top">
                <div class="ui grid l-r-pad">
                    ...
                    <div class="five wide computer eleven wide tablet eleven wide mobile column z-t-b-p-m zero-t-b-p"><a class="item logo-item w-100 p-l-0 desktop-remove" href="/">
                    <img class="logo mobile-logo" alt="roqqu logo" src="~/assets/img/roqqu.png"></a>
                    ...
                    <div class="ui three column doubling stackable grid container">
                        <div class="four wide column">
                            <div class="ui large vertical menu w-100 settings" style="border: none; box-shadow: none; margin-bottom: 0px;">
                                    ...
                                    <nuxt-link to="Accounts" class="item zero-t-b-p active"> 
                                        <div class="ui double column grid">
                                    ...
                                    <nuxt-link to="Verification" class="item zero-t-b-p active"> 
                                        <div class="ui double column grid">

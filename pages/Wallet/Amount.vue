<template>
  <div>
    ...
    <div class="text-center card-header p-20">
        <h2 class="font-bold" style="margin-bottom: 0px; font-weight: 400;">Enter Amount</h2>
        <h3 style="margin-top: 0px; font-weight: 400;">How much do you want to deposit ?</h3>
    </div>
    <div class="ui four column doubling stackable grid container" style="margin-top: 30px;">
        <div class="sixteen wide column">
            <div class="ui card deposit-card" style="padding-top: 20px;">
                <div class="ui form">
                    <div class="ui grid">
                        <div class="seven wide column"><small>NGN</small><input placeholder="Amount" class="action-input" type="text" value=""></div>
                        <div class="two wide column"><span style="display: block; margin-top: 40px; font-size: 28px;">=</span></div>
                        <div class="seven wide column"><small>USD</small><input placeholder="Amount" class="action-input" type="text" value="0"></div>
                    </div>
                    <div>
                        <div class="ui segment">
                            <div class="ui toggle checkbox include-fee"><input class="hidden" readonly="" tabindex="0" type="checkbox" value=""><label>Include fees in calculation</label></div>
                        </div><small>Maximum is 1,000,000 and minimum is 5,000</small>
                        <nuxt-link to="Options"><button disabled="" type="submit" class="blue ui button m-t-4" style="width: 100%;">Proceed with deposit</button></nuxt-link>
                    </div>
                </div>
            </div>
        </div>

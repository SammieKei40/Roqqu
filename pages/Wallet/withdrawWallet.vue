    ...
    <div class="grid container">
        <div class="ui four column doubling stackable grid container" style="margin-top: 30px;">
            <div class="sixteen wide column">
                <div class="ui card deposit-card" style="border: 0.5px dashed rgb(0, 29, 83);">
                    <h2 class="text-center font-bold" style="font-weight: 400; padding-bottom: 10px;">P2P Withdrawal</h2>
                    <div class="ui form">
                        <div class="field"><label>Select Wallet</label>
                            <div class="ui negative message" style="width: 100%;">
                                <p class="text-orange"><i class="icon exclamation triangle"></i>Roqqu is in no way partnering or have any affiliation with these apps, we do not in any way have control over those platforms and cannot do anything if you loose your money on those apps</p>
                            </div>
                            <div style="padding: 0px;">
                                <div class="ui grid product-chooser" style="display: block; margin-left: 0px; margin-right: 0px;">
                                    <div class="ui five wide column mr-12-10 product-chooser-item selected" style="padding: 0px;"><img alt="hometown logo" class="airtime-card" src="/static/media/hometown.cb4b58c4.png"></div>
                                    <div class="text-center ui five wide column mr-25-20 product-chooser-item" style="padding: 0px; margin-right: 8px;"><img alt="wallet africa app logo" class="airtime-card" src="/static/media/wallets.4b1755f5.png"></div>
                                    <div class="ui five wide column product-chooser-item" style="padding: 0px; float: right;"><img alt="raven app logo" class="airtime-card" src="/static/media/raven.c1fc555e.png"></div>
                                    <div class="text-center ui five wide column mr-25-20 product-chooser-item" style="padding: 0px; margin-right: 8px;"><img alt="abeg app logo" class="airtime-card" src="/static/media/carbon.c39bc9bd.png"></div>
                                    <div class="text-center ui five wide column mr-25-20 product-chooser-item" style="padding: 0px; margin-right: 8px;"><img alt="abeg app logo" class="airtime-card" src="/static/media/barter.f578dd9d.png"></div>
                                    <div class="ui five wide column product-chooser-item" style="padding: 0px; float: right;"><img alt="abeg app logo" class="airtime-card" src="/static/media/opay.bc109faa.png"></div>
                                </div>
                            </div>
                        </div>
                        <div class="field"><label>Phone Number on App</label><input placeholder="Enter phone number" type="text" value=""></div>
                        <div class="field">
                            <div class="ui placeholder field hide" style="margin-top: -10px;">
                                <div>
                                    <div class="line"></div>
                                    <div class="line"></div>
                                </div>
                            </div>
                            <div class="ui items hide" style="margin-top: 0px;">
                                <div class="item" style="margin-top: 0px; margin-bottom: 0px;">
                                    <div class="middle aligned content">
                                        <div class="ui negative message" style="width: 100%;">
                                            <p class="text-orange"><i class="icon exclamation triangle"></i>Could not verify phone number or username.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="field"><label>Amount</label>
                            <div class="ui left labeled input">
                                <div class="ui basic label" style="font-weight: 400; line-height: 2em; height: 48px;">NGN</div><input placeholder="Amount (min 500, max 500,000)" class="max-w-v" type="text" value="">
                            </div><span class="text-blue" style="border-bottom: 1px dashed rgb(238, 238, 238); display: inline-block; margin-top: 10px;">Balance: NGN 0</span>
                        </div>
                    </div>
                    <div><button to="/wallet/services/p2_with" class="ui disabled button ui button w-100 violet btn" disabled="" tabindex="-1" style="margin-top: 10px;">Proceed</button><a id="moveTop2" href="/wallet/services/p2_with"></a></div>
                </div>
            </div>
        </div>
    </div>
